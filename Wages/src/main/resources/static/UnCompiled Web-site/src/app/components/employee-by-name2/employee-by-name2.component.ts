...
@Component({
  selector: 'app-employee-by-name2',
  templateUrl: './employee-by-name2.component.html',
  styleUrls: ['./employee-by-name2.component.css']
})
export class EmployeeByName2Component implements OnInit {
