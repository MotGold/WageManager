...
@Component({
  selector: 'app-employee-by-depatment2',
  templateUrl: './employee-by-depatment2.component.html',
  styleUrls: ['./employee-by-depatment2.component.css']
})
export class EmployeeByDepatment2Component implements OnInit {
