...
@Component({
  selector: 'app-archive-by-department2',
  templateUrl: './archive-by-department2.component.html',
  styleUrls: ['./archive-by-department2.component.css']
})
export class ArchiveByDepartment2Component implements OnInit {
