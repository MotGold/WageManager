...
@Component({
  selector: 'app-archive-by-id2',
  templateUrl: './archive-by-id2.component.html',
  styleUrls: ['./archive-by-id2.component.css']
})
export class ArchiveById2Component implements OnInit {
