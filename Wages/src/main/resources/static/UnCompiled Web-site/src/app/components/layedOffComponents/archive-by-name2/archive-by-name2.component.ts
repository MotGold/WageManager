...
@Component({
  selector: 'app-archive-by-name2',
  templateUrl: './archive-by-name2.component.html',
  styleUrls: ['./archive-by-name2.component.css']
})
export class ArchiveByName2Component implements OnInit {
